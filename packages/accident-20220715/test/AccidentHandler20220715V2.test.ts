...
import { AccidentHandler20220715V2, MockERC20 } from '../typechain';
import { SignerWithAddress } from '@nomiclabs/hardhat-ethers/signers';
import { BigNumber } from 'ethers';

use(chaiAsPromised)

describe('AccidentHandler20220715V2', function () {
  let minter: SignerWithAddress;
  let handler: AccidentHandler20220715V2;
  let token: MockERC20;
  ...
  before(async () => {
    ...
    const AccidentHandler20220715V2 = await ethers.getContractFactory('AccidentHandler20220715V2');
    handler = await AccidentHandler20220715V2.connect(minter).deploy();
