...
contract DoubleBond is AccessControl, CloneFactory {
    ...
    constructor(
        ...
        for (uint256 i = 0; i < phasenum; i++) {
            ...
            string memory name = string(
                abi.encodePacked(string(abi.encodePacked(duration.toString(), "Epoch#")), i.toString())
            );
            string memory symbol = string(
                abi.encodePacked(string(abi.encodePacked(duration.toString(), "EP#")), i.toString())
            );
    ...
    function renewal(
        ...
        for (uint256 j = 0; j < needcreate; j++) {
            ...
            string memory name = string(
                abi.encodePacked(string(abi.encodePacked(duration.toString(), "Epoch#")), (j + idnum).toString())
            );
            string memory symbol = string(
                abi.encodePacked(string(abi.encodePacked(duration.toString(), "EP#")), (j + idnum).toString())
            );
