...
enum Names {
  ...
  ExtendableBondedReaderCake = 'ExtendableBondedReaderCake',
}
  ...
  await advancedDeploy(
    {
      ...
      logger,
      proxied: true,
      name: Names.ExtendableBondedReaderCake,
    },
    async ({ name }) => {
      return await deploy(name, {
        from: deployer,
          ...
          execute: {
            init: {
              ...
              args: [
                ...
                config.address.CakeMasterChefV2[networkName],
                config.address.PancakeLpTokenPair__CAKE_BUSD[networkName],
                config.address.PancakeLpTokenPair__DUET_anyUSD[networkName],
              ],
            },
          },
        },
